...
(function() {
    ...
    const styles = `
        ...
        .n8n-chat-widget .close-button::before {
            content: '\\25BC';
            font-size: 20px;
        }
        ...
        .n8n-chat-widget .brand-header span {
            ...
            font-weight: 500;
            color: white;
            display: none; /* Hide brand name as per photo */
        }

        .n8n-chat-widget .new-conversation {
            display: none; /* Hide new conversation screen to show chat directly */
        }
